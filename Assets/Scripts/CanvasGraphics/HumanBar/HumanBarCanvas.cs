...
namespace CanvasGraphics.HumanBar
{
    public class HumanBarCanvas : MonoBehaviour
    {
        ...
        [SerializeField] private TweenAnimatedUIElement countElem;
        ...
        private void PlayBarAnimaiton()
        {
            ...
            var humanCount = 0;
            countElem.Show();
            Invoke(nameof(DelayHideCount), hideCountDelay);
        ...
        private void DelayHideCount() => countElem.Hide();
        ...
        private void UpdateItem(GenderType genderType, ItemScore itemScore, int humanCount)
        {
            ...
            if (itemScore.UnlockedIds.Contains(id) || id == -1) return;
